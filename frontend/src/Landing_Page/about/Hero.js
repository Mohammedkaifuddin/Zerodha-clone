            ...
            <div className='row p-5 mt-5 border-top text-muted' style=  {{lineHeight:"1.8", fontSize:"1.2em"}}>
                ...
                <div className='col-6 p-5'>
                    ...
                    <p>
                        ...
                        <a href="https://zerodha.com/z-connect/" style={{ textDecoration: "none" }}> blog
                        </a> or see what the media is <a href="https://zerodha.com/media" style={{ textDecoration: "none" }}>saying about us</a>  or learn more about our business and product <a href="https://zerodha.com/about/philosophy/" style={{ textDecoration: "none" }}>philosophies</a> .
                    </p>
                </div>
            </div>
        </div>
