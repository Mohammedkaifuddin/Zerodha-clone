    ...
    return ( 
        <div className='container p-3'>
            <div className='row p-5'>
                ...
                <div className="col-6 p-5">
                    <img src="media/ecosystem.png" alt="Zerodha ecosystem illustration" style={{ width: "90%" }} />
                    <div className="text-center">
                        <a href="#exploreourproduct" className="mx-3" style={{ textDecoration: "none" }}>
                            Explore our products{" "}
                            <i class="fa fa-long-arrow-right" aria-hidden="true"></i>
                        </a>
                        <a href="#try-kite" className='mx-' style={{ textDecoration: "none" }}>
                            Try Kite demo{" "}
                            <i class="fa fa-long-arrow-right" aria-hidden="true"></i>
                        </a>
                    </div>
